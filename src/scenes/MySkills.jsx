...
const MySkills = () => {
  const isAboveExtraLargeScreen = useMediaQuery("(min-width: 1700px)");
  const isAboveLargeScreen = useMediaQuery("(min-width: 1200px)");
  const isAboveMediumScreen = useMediaQuery("(min-width: 1060px)");
  const isAboveSmallScreen = useMediaQuery("(min-width: 768px)");
  const isAboveSmallSmallScreen = useMediaQuery("(min-width: 620px)");
  const isAboveExtraSmallScreen = useMediaQuery("(min-width: 480px)");
  ...
  const is1061Screen = useMediaQuery("(min-width: 1100px)");
  const is1060Screen = useMediaQuery("(min-width: 1060px)");

  const sentence1 = "MY ".split("");
    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            assdasda asdasdasdaasda asdasda sda asdasdada asdasdasdasdaasdasda
            asdasdasd.
          </p>
        </motion.div>
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            aASDASDASDASDASD ASDA SADASD ASDASD ASDASDASDASD
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">asdasdasda asdasddddfs xcvcnbmhky yhjhjkhjk</p>
        </motion.div>
